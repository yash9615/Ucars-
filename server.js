...
// Supabase connection (uses DATABASE_URL from Render environment variables)
const pool = new Pool({
...
async function initDatabase() {
    const queries = [
        ...
        `INSERT INTO admin (username, password) SELECT 'admin', 'admin123' WHERE NOT EXISTS (SELECT 1 FROM admin)`
    ];
